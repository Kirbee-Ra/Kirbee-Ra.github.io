...
- [3상 시스템](#3상-시스템)
- [평형 3상 시스템](#평형-3상-시스템)
- [3상 시스템의 발전기](#3상-시스템의-발전기)
- [3상 전원의 Y 결선](#3상-전원의-y-결선)
- [3상 전원의 Δ 결선](#source-delta-connection)
- [부하의 Y 결선과 Δ 결선](#y-delta-connection)
- [최대 전력 전달](#최대-전력-전달)
- [역률 개선](#역률-개선)
- [전력 측정](#전력-측정)
...
<h2 id="source-delta-connection">3상 전원의 Δ 결선</h2>
...
단상 시스템의 경우는 다음의 조건 하에 부하로 전달되는 전력이 최대가 되었습니다.
...
3상 시스템 또한 동일합니다.
회로의 임피던스와 부하 임피던스가 켤레 관계가 되도록 소자 값을 조정하면 됩니다.
