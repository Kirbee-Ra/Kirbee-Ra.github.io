...
실선은 원래의 전류 피드백 신호이고, 점선이 변화된 피드백 신호입니다.
시간이 지날 수록 두 신호의 간격이 줄어들면서 결국 격차가 사라집니다.
즉, 컨버터가 안정된 상태입니다.
하지만 듀티 비가 $$0.5$$보다 큰 경우는 달라집니다.

(>0.5 waveform)

시간이 지날 수록 격차가 더 벌어집니다.
